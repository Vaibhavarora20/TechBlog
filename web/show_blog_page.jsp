...
<html>
    <head>
        ...
        <title><%= p.getpTitle()%> || TechBlog by Learn Code with Us </title>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="profile.jsp"> <span class="	fa fa-bell-o"></span> LearnCode with Us <span class="sr-only">(current)</span></a>
                    </li>
